...
if __name__ == "__main__":
    ...
    parser.add_argument('--image', '-i', type=str, default=r"E:\work\drawing_analysis\dataset\obb_all_graphes\annotation\images_dimension_crop\253_17_roi5_dimension_1.png",
                        help='图片文件路径')
    parser.add_argument('--label', '-l', type=str, default=r"E:\work\drawing_analysis\dataset\obb_all_graphes\annotation\labels_arrowhead_in_dimension\dota_txt\253_17_roi5_dimension_1.txt",
                        help='DOTA格式标签文件路径')
